...
const SubAdminStats = () => {
    const stats = [
        { label: 'Total Sub-Admins', value: '24', icon: Users, color: '#4f46e5', bg: '#eef2ff' },
        { label: 'Active Now', value: '18', icon: UserCheck, color: '#10b981', bg: '#ecfdf5' },
        { label: 'Pending Invites', value: '3', icon: UserPlus, color: '#f59e0b', bg: '#fffbeb' },
        { label: 'Roles Defined', value: '6', icon: Shield, color: '#6366f1', bg: '#f5f3ff' },
    ];
